...
"[project]/app/api/shifts/attendants/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const accessCheck = await pool.query(`SELECT 1 FROM shifts s
       ...
       AND (b.vendor_id = $3 OR s.branch_id = $4)`, [
        ...
        const attendantsResult = await pool.query(`SELECT DISTINCT s.staff_id, st.id, st.full_name, st.username
       FROM sales s
       ...
       ORDER BY st.full_name`, [
        ...
        const appPaymentsResult = await pool.query(`SELECT staff_id, SUM(total_amount) as total
       FROM sales
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2e1a03e9._.js.map