...
async function POST(request) {
    try {
        ...
        const { company_name, contact_name, contact_email, contact_phone, stage, assigned_to, notes, expected_value, expected_close_date, source } = body;
...
async function PUT(request) {
    try {
        const body = await request.json();
        const { id, company_name, contact_name, contact_email, contact_phone, stage, assigned_to, notes, expected_value, expected_close_date, source } = body;
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`
      UPDATE leads 
