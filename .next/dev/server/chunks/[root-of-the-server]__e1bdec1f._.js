...
async function POST(request) {
    try {
        ...
        const { company_name, trading_name, kra_pin, contact_name, contact_email, contact_phone, stage, assigned_to, notes, expected_value, expected_close_date, source } = body;
...
async function DELETE(request) {
    try {
      ...
      `, [
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`DELETE FROM leads WHERE id = $1`, [
            id
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e1bdec1f._.js.map