...
"[project]/app/api/banking-accounts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getVendorId(client, session) {
...
async function GET(request) {
    ...
    try {
        ...
        const result = await client.query(`SELECT id, account_name, account_number, bank_name, branch_name, is_default, is_active, created_at, updated_at
...
async function POST(request) {
    ...
    try {
        ...
        const result = await client.query(`INSERT INTO banking_accounts (vendor_id, account_name, account_number, bank_name, branch_name, is_default)
...
async function PUT(request) {
    ...
    try {
        ...
        const accountCheck = await client.query('SELECT id, is_default FROM banking_accounts WHERE id = $1 AND vendor_id = $2', [
            id,
            vendorId
        ]);
        ...
        const result = await client.query(`UPDATE banking_accounts 
       ...
       RETURNING id, account_name, account_number, bank_name, branch_name, is_default, is_active, created_at, updated_at`, [
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: "Failed to update banking account"
        }, {
            status: 500
        });
    } finally{
...
async function DELETE(request) {
    ...
    try {
        ...
        if (accountCheck.rows[0].is_default) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: "Cannot delete the default Cashdrop account"
            }, {
                status: 400
            });
        }
        await client.query('DELETE FROM banking_accounts WHERE id = $1 AND vendor_id = $2', [
            id,
            vendorId
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: "Failed to delete banking account"
        }, {
            status: 500
        });
    } finally{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__75684cc0._.js.map