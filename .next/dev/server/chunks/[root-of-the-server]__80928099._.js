...
"[project]/app/api/branches/earning-rules/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request) {
    try {
        ...
        if (!loyalty_earn_type || ![
            'per_litre',
            'per_amount'
        ].includes(loyalty_earn_type)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: "loyalty_earn_type must be 'per_litre' or 'per_amount'"
            }, {
                status: 400
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__80928099._.js.map