...
"[project]/app/api/branches/[id]/intermittency-rate/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const result = await pool.query(`SELECT id, name, bulk_sales_kra_percentage 
       FROM branches 
...
async function PUT(request, { params }) {
    try {
        ...
        if (intermittency_rate === undefined || intermittency_rate === null) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "intermittency_rate is required"
            }, {
                status: 400
            });
        }
        ...
        if (isNaN(rate) || rate < 0 || rate > 100) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "intermittency_rate must be between 0 and 100"
            }, {
                status: 400
            });
        }
        const branchCheck = await pool.query(`SELECT id FROM branches WHERE id = $1 AND ($2::uuid IS NULL OR vendor_id = $2)`, [
            branchId,
            vendor_id
        ]);
        ...
        await pool.query(`UPDATE branches SET bulk_sales_kra_percentage = $1, updated_at = NOW() WHERE id = $2`, [
            rate,
            branchId
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__007da4d0._.js.map