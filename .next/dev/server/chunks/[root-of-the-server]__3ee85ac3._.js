...
async function callKraCreditNote(creditNoteData) {
    ...
    try {
        ...
        const serverAddr = branchConfig.server_address?.replace(/^https?:\/\//, '') || '5.189.171.160';
        const serverPort = branchConfig.server_port || '8088';
        const kraEndpoint = `http://${serverAddr}:${serverPort}/trnsSales/saveSales`;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3ee85ac3._.js.map