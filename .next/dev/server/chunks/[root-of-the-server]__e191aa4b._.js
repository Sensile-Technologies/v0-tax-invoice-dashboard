...
async function GET(request) {
    try {
        ...
        const result = await pool.query("SELECT * FROM tanks WHERE branch_id = $1 ORDER BY tank_name", [
            branchId
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
...
async function POST(request) {
    try {
        ...
        const result = await pool.query(`INSERT INTO tanks (branch_id, tank_name, fuel_type, capacity, current_stock, status)
       VALUES ($1, $2, $3, $4, $5, $6)
       RETURNING *`, [
            branch_id,
            tank_name,
...
async function PATCH(request) {
    try {
        ...
        values.push(id);
        const result = await pool.query(`UPDATE tanks SET ${updates.join(", ")} WHERE id = $${paramIndex} RETURNING *`, values);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: result.rows[0]
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e191aa4b._.js.map