...
"[project]/app/api/staff/reset-password/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        let staffResult;
        if (staffId) {
            staffResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT id, user_id, email FROM staff WHERE id = $1`, [
                staffId
            ]);
        } else {
            staffResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT id, user_id, email FROM staff WHERE email = $1`, [
                email
            ]);
        }
        ...
        if (staff.user_id) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE users SET password_hash = $1, must_change_password = true, updated_at = NOW() WHERE id = $2`, [
                hashedPassword,
                staff.user_id
            ]);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e13ca110._.js.map