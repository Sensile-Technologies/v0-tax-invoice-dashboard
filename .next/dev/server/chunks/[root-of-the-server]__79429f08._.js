...
"[project]/app/api/admin/vendors/[id]/branches/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    try {
        ...
        if (branchCheck.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Branch not found or does not belong to this vendor"
            }, {
                status: 404
            });
        }
    ...
    `, [
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            message: "Branch KRA configuration updated"
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__79429f08._.js.map