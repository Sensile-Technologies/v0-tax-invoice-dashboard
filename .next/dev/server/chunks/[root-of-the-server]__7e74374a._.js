...
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$kra$2d$items$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
async function POST(request, { params }) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$kra$2d$items$2d$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resendItemToKra"])(id);
        console.log(`[Items API] KRA resend result for ${id}:`, result);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: result.success,
            kraResponse: result.kraResponse,
            message: result.success ? "Item successfully submitted to KRA" : `KRA submission failed: ${result.error || result.kraResponse?.resultMsg || 'Unknown error'}`
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7e74374a._.js.map