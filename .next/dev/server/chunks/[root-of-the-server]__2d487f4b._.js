...
"[project]/app/api/admin/vendors/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const vendors = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`
      SELECT 
        v.*,
      ...
      ORDER BY v.name
    `);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(vendors);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO vendors (name, email, phone, address, billing_email, subscription_plan)
       VALUES ($1, $2, $3, $4, $5, $6)
       RETURNING *`, [
            name,
            email,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2d487f4b._.js.map