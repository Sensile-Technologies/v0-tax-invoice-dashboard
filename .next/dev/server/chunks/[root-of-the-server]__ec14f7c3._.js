...
"[project]/app/api/kra/notices/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    const logger = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createApiLogger"])("/api/kra/notices", "POST");
    let kraPayload = null;
    let kraEndpoint = "";
    try {
        ...
        if (noticeList.length > 0) {
            ...
            for (const item of noticeList){
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO notices (branch_id, tin, bhf_id, notce_no, title, cont, dtl_url, remark, last_req_dt)
        ...
        const transformedData = noticeList.map((item)=>({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ec14f7c3._.js.map