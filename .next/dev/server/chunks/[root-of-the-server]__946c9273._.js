...
async function POST(request) {
    try {
        ...
        const { branch_id, dispenser_id, nozzle_number, fuel_type, status, item_id, tank_id } = body;
        ...
        const result = await pool.query(`INSERT INTO nozzles (branch_id, dispenser_id, nozzle_number, fuel_type, status, item_id, tank_id)
...
async function PUT(request) {
    try {
        const body = await request.json();
        const { id, nozzle_number, fuel_type, status, item_id, tank_id } = body;
        if (!id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
