    ...
    try {
        ...
        if (itemClsList.length > 0) {
            ...
            for (const item of itemClsList){
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO item_classifications (item_cls_cd, item_cls_nm, item_cls_lvl, tax_ty_cd, mjr_tg_yn, use_yn, last_req_dt)
           ...
           ON CONFLICT (item_cls_cd) DO UPDATE SET
             ...
             last_req_dt = NOW()`, [
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO kra_item_classifications (bhf_id, item_cls_cd, item_cls_nm, item_cls_lvl, tax_ty_cd, mjr_tg_yn, use_yn, updated_at)
        ...
        const transformedData = itemClsList.map((item)=>({
        ...
        if (error.message.includes("fetch failed") || error.name === "FetchError" || error.message.includes("ConnectTimeoutError")) {
            errorMessage = "Cannot connect to KRA backend server. The server at " + kraEndpoint + " is not reachable. " + "Please check:\n" + "1. The backend server is running\n" + "2. The URL/Port is correct in backend configuration\n" + "3. The server is accessible from this network";
        }
        const errorResponse = {
            resultCd: "999",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__828cdd8d._.js.map