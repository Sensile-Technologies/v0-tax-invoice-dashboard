...
function CustomersPage() {
    ...
    const fetchCustomers = async ()=>{
        try {
            ...
            const { data, error } = await supabase.from("customers").select("id, tin, cust_tin, cust_nm, email, tel_no, adrs, branch_id").eq("branch_id", currentBranch.id).eq("use_yn", "Y").order("created_at", {
                ascending: false
            });
            if (error) throw error;
...
//# sourceMappingURL=_3ed1375d._.js.map