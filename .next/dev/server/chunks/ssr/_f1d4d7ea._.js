...
P051234568B,Another Customer,another@example.com,+254 700 000001,456 Oak Avenue,Mombasa,80100,More notes,all`;
    ...
    const handleRegisterCustomer = async ()=>{
        ...
        try {
            const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])();
            const { data: branchData, error: branchError } = await supabase.from("branches").select("id, name, bhf_id").eq("id", currentBranch.id).single();
            ...
            if (formData.branchScope === "all") {
                const { data: allBranches, error: allBranchesError } = await supabase.from("branches").select("id, name, bhf_id");
...
//# sourceMappingURL=_f1d4d7ea._.js.map