    ...
    const fetchDailySales = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            ...
            if (nozzleResult.success && nozzleResult.data?.nozzles) {
                const bulkByFuelType = new Map();
                nozzleResult.data.nozzles.forEach((nozzle)=>{
                    ...
                    if (bulkQty > 0) {
                        const existing = bulkByFuelType.get(baseFuelType) || {
                            quantity: 0,
                            amount: 0
                        };
                        const unitPrice = invoicedQty > 0 && nozzle.invoiced_amount > 0 ? parseFloat(nozzle.invoiced_amount) / invoicedQty : 180;
