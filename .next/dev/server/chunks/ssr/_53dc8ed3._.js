...
function TankManagement({ branchId }) {
    ...
    const handleAddDispenser = async ()=>{
        ...
        if (selectedTankIds.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Please select at least one tank");
            return;
        }
        try {
            ...
            const allDispenserNumbers = (existingDispensers || []).map((d)=>Number(d.dispenser_number) || 0);
            ...
            const fuelTypes = [
                ...new Set(selectedTanks.map((t)=>t.fuel_type))
            ];
...
//# sourceMappingURL=_53dc8ed3._.js.map