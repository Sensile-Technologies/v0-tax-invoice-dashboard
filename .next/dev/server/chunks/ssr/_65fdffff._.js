...
function EndShiftPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function loadData() {
            try {
                ...
                const outgoing = allStaff.filter((s)=>incomingAttendantIds.includes(s.id)).map((s)=>({
                        id: s.id,
                        name: s.full_name || s.username || 'Unknown'
                    }));
    ...
    const validateStep2 = ()=>{
        ...
        for (const attendant of outgoingAttendants){
            ...
            if (!mobileMoneyEntry || mobileMoneyEntry.amount === '') {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(`Please enter Mobile Money amount for ${attendant.name}`);
                return false;
            }
            if (!cashEntry || cashEntry.amount === '') {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(`Please enter Cash amount for ${attendant.name}`);
                return false;
            }
    ...
    const handleReconcile = async ()=>{
        ...
        if (shiftBanking.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Banking summary is mandatory. Please add at least one banking entry.");
            return;
        }
        const hasBankingWithAmount = shiftBanking.some((b)=>b.banking_account_id && parseFloat(b.amount) > 0);
        if (!hasBankingWithAmount) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Please enter a valid banking amount.");
            return;
        }
        setSubmitting(true);
        try {
