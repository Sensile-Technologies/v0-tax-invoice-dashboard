    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function loadData() {
            try {
                ...
                const attendantIds = [
                    ...new Set(shiftSales.map((s)=>s.attendant_id).filter(Boolean))
                ];
                const outgoing = (cashiersData.cashiers || []).filter((c)=>attendantIds.includes(c.id));
                setOutgoingAttendants(outgoing);
                const collections = {};
                for (const att of outgoing){
                    const attSales = shiftSales.filter((s)=>s.attendant_id === att.id);
                    const mpesaTotal = attSales.filter((s)=>s.payment_method === 'mpesa').reduce((sum, s)=>sum + parseFloat(s.total_amount || 0), 0);
                    const cardTotal = attSales.filter((s)=>s.payment_method === 'card').reduce((sum, s)=>sum + parseFloat(s.total_amount || 0), 0);
                    const mobileMoneyTotal = attSales.filter((s)=>s.payment_method === 'mobile_money').reduce((sum, s)=>sum + parseFloat(s.total_amount || 0), 0);
                    collections[att.id] = [
                        {
                            payment_method: 'cash',
                            amount: ''
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Failed to load shift data");
                router.push('/sales/summary');
            } finally{
                setLoading(false);
            }
                                                                                    ...
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$label$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Label"], {
                                                                                        ...
                                                                                        children: [
                                                                                            ...
                                                                                            [
                                                                                                ...
                                                                                                'card',
                                                                                                'mobile_money'
                                                                                            ].includes(payment.payment_method) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
