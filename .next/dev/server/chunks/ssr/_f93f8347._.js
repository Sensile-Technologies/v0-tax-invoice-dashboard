...
"[project]/app/sales/automated/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AutomatedSalesPage() {
    ...
    async function fetchData() {
        try {
            ...
            let query = supabase.from("sales").select("*").eq("branch_id", branchId).eq("is_automated", true).gte("sale_date", `${filters.startDate}T00:00:00`).lte("sale_date", `${filters.endDate}T23:59:59`).order("sale_date", {
                ascending: false
            });
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Failed to load automated sales data");
        } finally{
            setLoading(false);
        }
    }
    ...
    async function retryTransmission(saleId) {
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].info(`Retrying transmission for sale ${saleId}...`);
    }
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_f93f8347._.js.map