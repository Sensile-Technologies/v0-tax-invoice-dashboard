...
"[project]/app/api/receipt/image/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
[__TURBOPACK__imported__module__$5b$externals$5d2f$pg__$5b$external$5d$__$28$pg$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f$puppeteer__$5b$external$5d$__$28$puppeteer$2c$__esm_import$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
function getChromiumPath() {
    ...
    try {
        const path = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$child_process__$5b$external$5d$__$28$child_process$2c$__cjs$29$__["execSync"])('which chromium').toString().trim();
        if (path) return path;
    } catch  {}
    try {
        const path = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$child_process__$5b$external$5d$__$28$child_process$2c$__cjs$29$__["execSync"])('which chromium-browser').toString().trim();
        if (path) return path;
    } catch  {}
    try {
        const path = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$child_process__$5b$external$5d$__$28$child_process$2c$__cjs$29$__["execSync"])('which google-chrome').toString().trim();
        if (path) return path;
    } catch  {}
...
function generateReceiptHTML(sale, qrCodeDataUrl) {
    ...
    const timeStr = saleDate.toLocaleTimeString('en-KE', {
        hour: '2-digit',
        minute: '2-digit',
        second: '2-digit',
        hour12: false
    ...
    try {
        ...
        try {
         ...
         WHERE s.id = $1`, [
            ...
            const qrCodeDataUrl = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$qrcode$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].toDataURL(qrUrl, {
                width: 200,
                margin: 1,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__483bafec._.js.map