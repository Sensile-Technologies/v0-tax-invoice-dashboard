...
"[project]/app/api/vendor/settings/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (!user.vendor_id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "No vendor associated with user"
            }, {
                status: 400
            });
        }
...
async function PUT(request) {
    try {
        ...
        if (custom_domain) {
            ...
            if (existingVendor) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "This domain is already in use by another vendor"
                }, {
                    status: 400
                });
            }
        }
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE vendors 
       SET display_name = $1,
           logo_url = $2,
           primary_color = $3,
           secondary_color = $4,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3af85ab5._.js.map