...
async function GET(request) {
    try {
        ...
        const effectiveBranchId = [
            ...
            "supervisor",
            "manager"
        ].includes(role) ? branch_id : filterBranchId || null;
        let query = `
      SELECT 
        se.id,
        se.shift_id,
    ...
    `;
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pool"].query(query, params);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eff8489d._.js.map