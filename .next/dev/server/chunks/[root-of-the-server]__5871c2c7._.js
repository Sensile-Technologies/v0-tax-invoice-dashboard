...
__turbopack_context__.s([
    "execute",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["execute"],
    "pool",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pool"],
    "query",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"],
    "queryOne",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryOne"]
]);
...
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
async function GET() {
    try {
        ...
        const [revenueResult, lastMonthRevenueResult, transactionsResult, employeesResult, inventoryResult, lastMonthInventoryResult, branchStatsResult, monthlyRevenueResult] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`
      ...
      `),
        ...
        SELECT 
          ...
          COALESCE(SUM(CASE WHEN p.created_at >= $1 THEN p.total_amount ELSE 0 END), 0) as mtd_purchases
        FROM branches b
        LEFT JOIN sales s ON s.branch_id = b.id
        LEFT JOIN purchases p ON p.branch_id = b.id
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5871c2c7._.js.map