        ...
        try {
         ...
         VALUES ($1, $2, $3, $4, $5, NOW(), NOW())`, [
           ...
           RETURNING *`, [
                ...
                const branchResult = await client.query(`INSERT INTO branches (id, user_id, vendor_id, name, bhf_id, trading_name, kra_pin, location, address, county, local_tax_office, manager, email, phone, status, created_at, updated_at)
