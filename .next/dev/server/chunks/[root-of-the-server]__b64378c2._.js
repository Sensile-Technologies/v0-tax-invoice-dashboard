...
"[project]/app/api/staff/update/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const userCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT u.id, COALESCE(s.role, u.role) as role, v.id as vendor_id
       FROM users u
       ...
       WHERE u.id = $1`, [
        ...
        if (![
            'vendor',
            'director'
        ].includes(currentUser.role?.toLowerCase()) && !currentUser.vendor_id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Only vendors and directors can update staff"
            }, {
                status: 403
            });
        }
        // Get the vendor_id for the staff member to verify ownership
        const staffCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT s.id, s.user_id, b.vendor_id 
       FROM staff s 
       ...
       WHERE s.id = $1`, [
        ...
        if (!userVendorId) {
            const vendorCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT b.vendor_id FROM branches b JOIN staff s ON s.branch_id = b.id WHERE s.user_id = $1 LIMIT 1`, [
                session.id
            ]);
       ...
       WHERE id = $7`, [
        ...
        if (staffMember.user_id) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE users 
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b64378c2._.js.map