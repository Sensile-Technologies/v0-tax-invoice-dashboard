...
"[project]/app/api/stock/receive/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { branch_id, tank_id, quantity, unit_price, supplier_name, delivery_note, sync_to_kra = true } = body;
        ...
        const tankResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT * FROM tanks WHERE id = $1", [
            tank_id
        ]);
       ...
       VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING id`, [
        ...
        if (sync_to_kra) {
            ...
            kraResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$kra$2d$stock$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["syncStockWithKRA"])(branch_id, "stock_receive", [
                {
                    tankId: tank_id,
                    quantity: quantity,
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE tanks SET kra_sync_status = $1, last_kra_synced_stock = $2 WHERE id = $3`, [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__adf56d3e._.js.map