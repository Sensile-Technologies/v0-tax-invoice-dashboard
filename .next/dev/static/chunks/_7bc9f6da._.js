                ...
                try {
                    ...
                    const attendantIds = [
                        ...new Set(shiftSales.map({
                            "EndShiftPage.useEffect.loadData": (s)=>s.attendant_id
                        }["EndShiftPage.useEffect.loadData"]).filter(Boolean))
                    ];
                    const outgoing = (cashiersData.cashiers || []).filter({
                        "EndShiftPage.useEffect.loadData.outgoing": (c)=>attendantIds.includes(c.id)
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to load shift data");
                    router.push('/sales/summary');
                } finally{
                    setLoading(false);
                }
...
_s(EndShiftPage, "YeCcWpdTOGHyExtFC3P2Og8XoVw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
