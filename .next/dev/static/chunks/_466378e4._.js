        ...
        "DailySalesReportPage.useCallback[fetchDailySales]": async ()=>{
            try {
                ...
                if (nozzleResult.success && nozzleResult.data?.nozzles) {
                    ...
                    nozzleResult.data.nozzles.forEach({
                        "DailySalesReportPage.useCallback[fetchDailySales]": (nozzle)=>{
                    ...
                    bulkByFuelType.forEach({
                        "DailySalesReportPage.useCallback[fetchDailySales]": (data, fuelType)=>{
...
_s(DailySalesReportPage, "pZwinuNZLbSs0Vv3JG7HzLPb6CQ=", false, function() {
    return [
