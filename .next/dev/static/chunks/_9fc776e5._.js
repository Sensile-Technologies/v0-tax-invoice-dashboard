...
function ItemsListPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ItemsListPage.useEffect": ()=>{
            const fetchItems = {
                "ItemsListPage.useEffect.fetchItems": async ()=>{
                    try {
                        ...
                        if (result.success) {
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to load items");
                        }
                    } catch (error) {
            ...
            }["ItemsListPage.useEffect.fetchItems"];
            fetchItems();
        }
    }["ItemsListPage.useEffect"], []);
    const [resendingItems, setResendingItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(new Set());
    const handleResendToKra = async (itemId)=>{
        ...
        try {
            ...
            const result = await response.json();
            if (result.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Item successfully submitted to KRA");
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(result.message || "Failed to submit item to KRA");
                setItems(items.map((item)=>item.id === itemId ? {
                        ...item,
                        kra_status: 'rejected',
                        kra_last_synced_at: new Date().toISOString()
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to resend item to KRA");
        } finally{
    ...
    const handleStatusToggle = async (itemId, currentStatus)=>{
        ...
        try {
            ...
            if (response.ok) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Item ${newStatus === "active" ? "activated" : "deactivated"}`);
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to update item status");
            }
        } catch (error) {
...
_s(ItemsListPage, "5do/0qNReITIncw8JnXg3+7pCt8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
_c = ItemsListPage;
var _c;
__turbopack_context__.k.register(_c, "ItemsListPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_9fc776e5._.js.map