...
function SignUpPage() {
    ...
    const [bhfId, setBhfId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const handleSignUp = async (e)=>{
        ...
        setError(null);
        try {
            const { data, error: signUpError } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signUp"])(email, password, {
                username,
                phone: phoneNumber
            });
...
_s(SignUpPage, "2zLdYyeaxL5LQ++diYMEK+DEjIc=", false, function() {
    return [
