...
function SalesSummaryContent() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SalesSummaryContent.useEffect": ()=>{
            ...
            return ({
                "SalesSummaryContent.useEffect": ()=>window.removeEventListener("storage", handleStorageChange)
            })["SalesSummaryContent.useEffect"];
        }
    }["SalesSummaryContent.useEffect"], []);
    ...
    async function handleIssueInvoice() {
        ...
        try {
            ...
            if (result.success) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(result.error || "Failed to issue invoice");
            }
        } catch (error) {
            console.error("Error issuing invoice:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to issue invoice");
        } finally{
...
_s(SalesSummaryContent, "yJYHEvfFFEeKXXX3RKbgtyqUwok=", false, function() {
    return [
