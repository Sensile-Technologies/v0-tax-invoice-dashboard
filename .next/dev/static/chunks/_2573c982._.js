...
function AutomatedSalesPage() {
    ...
    async function handleResubmitPageToKra() {
        ...
        if (pendingSales.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info("No pending invoices to resubmit on this page");
            return;
        }
        setBulkResubmitting(true);
        let successCount = 0;
        let failCount = 0;
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].loading(`Resubmitting ${pendingSales.length} invoices to KRA...`);
