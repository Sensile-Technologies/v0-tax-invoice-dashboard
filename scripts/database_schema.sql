...
\restrict XC55dFbilnt4ouAHha8zpnQ9WGwSMayUdaB86XKLdtzBUSuowaBInedoWEhoX94
...
CREATE TABLE public.kra_item_classifications (
    ...
    item_cls_nm character varying(255),
...
--
-- Name: idx_fuel_prices_branch_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_fuel_prices_branch_id ON public.fuel_prices USING btree (branch_id);
...
--
-- Name: fuel_prices update_fuel_prices_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: fuel_prices fuel_prices_branch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fuel_prices
    ADD CONSTRAINT fuel_prices_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id) ON DELETE CASCADE;
...
\unrestrict XC55dFbilnt4ouAHha8zpnQ9WGwSMayUdaB86XKLdtzBUSuowaBInedoWEhoX94
