--
-- Flow360 Production Database Schema
-- Safe to run on existing database (uses IF NOT EXISTS / CREATE OR REPLACE)
--
...
CREATE INDEX IF NOT EXISTS idx_fuel_prices_branch_id ON public.fuel_prices USING btree (branch_id);
