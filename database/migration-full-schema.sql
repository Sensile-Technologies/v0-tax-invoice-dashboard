...
--
-- Name: attendant_collections; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.attendant_collections (
...
--
-- Name: bulk_sales; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: shift_banking; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.shift_banking (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    shift_id uuid NOT NULL,
    banking_account_id uuid NOT NULL,
...
--
-- Name: shift_expenses; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.shift_readings (
    ...
    incoming_attendant_id uuid,
    rtt numeric DEFAULT 0,
    self_fueling numeric DEFAULT 0,
    prepaid_sale numeric DEFAULT 0,
...
CREATE TABLE public.shifts (
    ...
    CONSTRAINT shifts_reconciliation_status_check CHECK ((reconciliation_status = ANY (ARRAY['pending'::text, 'reconciled'::text])))
);
...
--
-- Name: attendant_collections attendant_collections_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.attendant_collections
    ADD CONSTRAINT attendant_collections_pkey PRIMARY KEY (id);
...
--
-- Name: bulk_sales bulk_sales_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bulk_sales
    ADD CONSTRAINT bulk_sales_pkey PRIMARY KEY (id);
...
--
-- Name: expense_accounts expense_accounts_vendor_id_account_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.expense_accounts
    ADD CONSTRAINT expense_accounts_vendor_id_account_name_key UNIQUE (vendor_id, account_name);
...
--
-- Name: shift_banking shift_banking_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.shift_banking
    ADD CONSTRAINT shift_banking_pkey PRIMARY KEY (id);


--
-- Name: shift_expenses shift_expenses_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_banking_accounts_vendor; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_banking_accounts_vendor ON public.banking_accounts USING btree (vendor_id);


--
-- Name: idx_branch_items_available; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_branch_items_available ON public.branch_items USING btree (branch_id, is_available) WHERE (is_available = true);
...
--
-- Name: idx_branch_items_branch_item; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_branch_items_branch_item ON public.branch_items USING btree (branch_id, item_id);
...
--
-- Name: idx_bulk_sales_branch_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bulk_sales_branch_date ON public.bulk_sales USING btree (branch_id, created_at DESC);


--
-- Name: idx_bulk_sales_branch_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bulk_sales_branch_id ON public.bulk_sales USING btree (branch_id);


--
-- Name: idx_bulk_sales_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bulk_sales_created_at ON public.bulk_sales USING btree (created_at);


--
-- Name: idx_bulk_sales_shift_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bulk_sales_shift_id ON public.bulk_sales USING btree (shift_id);
...
--
-- Name: idx_dispenser_tanks_dispenser_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dispenser_tanks_dispenser_id ON public.dispenser_tanks USING btree (dispenser_id);


--
-- Name: idx_dispenser_tanks_tank_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dispenser_tanks_tank_id ON public.dispenser_tanks USING btree (tank_id);
...
--
-- Name: idx_expense_accounts_vendor; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_expense_accounts_vendor ON public.expense_accounts USING btree (vendor_id);
...
--
-- Name: idx_nozzles_item_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_nozzles_item_id ON public.nozzles USING btree (item_id);
...
--
-- Name: idx_sales_branch_created_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sales_branch_created_desc ON public.sales USING btree (branch_id, created_at DESC);


--
-- Name: idx_sales_branch_date_kra; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sales_branch_date_kra ON public.sales USING btree (branch_id, sale_date, kra_status);


--
-- Name: idx_sales_branch_fuel_amount; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sales_branch_fuel_amount ON public.sales USING btree (branch_id, fuel_type, total_amount);
...
--
-- Name: idx_sales_item_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_sales_kra_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sales_kra_status ON public.sales USING btree (kra_status);


--
-- Name: idx_sales_nozzle_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_sales_shift_nozzle; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sales_shift_nozzle ON public.sales USING btree (shift_id, nozzle_id);
...
--
-- Name: idx_sales_transmission_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sales_transmission_status ON public.sales USING btree (transmission_status);


--
-- Name: idx_shift_banking_account; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_shift_banking_account ON public.shift_banking USING btree (banking_account_id);


--
-- Name: idx_shift_banking_shift; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_shift_banking_shift ON public.shift_banking USING btree (shift_id);


--
-- Name: idx_shift_expenses_branch; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_shift_expenses_branch ON public.shift_expenses USING btree (branch_id);


--
-- Name: idx_shift_expenses_shift; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_shift_expenses_shift ON public.shift_expenses USING btree (shift_id);


--
-- Name: idx_shift_readings_nozzle; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_shift_readings_nozzle ON public.shift_readings USING btree (nozzle_id);


--
-- Name: idx_shift_readings_shift_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_shift_readings_shift_id ON public.shift_readings USING btree (shift_id);


--
-- Name: idx_shift_readings_shift_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_shift_readings_shift_type ON public.shift_readings USING btree (shift_id, reading_type);
...
--
-- Name: idx_shifts_branch_start; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_shifts_branch_start ON public.shifts USING btree (branch_id, start_time DESC);


--
-- Name: idx_shifts_branch_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_shifts_branch_status ON public.shifts USING btree (branch_id, status);
...
--
-- Name: idx_shifts_start_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_shifts_start_time ON public.shifts USING btree (start_time DESC);
...
--
-- Name: idx_tanks_item_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_tanks_item_id ON public.tanks USING btree (item_id);
...
--
-- Name: attendant_collections attendant_collections_branch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.attendant_collections
    ADD CONSTRAINT attendant_collections_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id) ON DELETE CASCADE;


--
-- Name: attendant_collections attendant_collections_shift_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.attendant_collections
    ADD CONSTRAINT attendant_collections_shift_id_fkey FOREIGN KEY (shift_id) REFERENCES public.shifts(id) ON DELETE CASCADE;


--
-- Name: attendant_collections attendant_collections_staff_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.attendant_collections
    ADD CONSTRAINT attendant_collections_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES public.staff(id) ON DELETE CASCADE;


--
-- Name: banking_accounts banking_accounts_vendor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.banking_accounts
    ADD CONSTRAINT banking_accounts_vendor_id_fkey FOREIGN KEY (vendor_id) REFERENCES public.vendors(id) ON DELETE CASCADE;
...
--
-- Name: bulk_sales bulk_sales_branch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bulk_sales
    ADD CONSTRAINT bulk_sales_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id);


--
-- Name: bulk_sales bulk_sales_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bulk_sales
    ADD CONSTRAINT bulk_sales_item_id_fkey FOREIGN KEY (item_id) REFERENCES public.items(id);


--
-- Name: bulk_sales bulk_sales_nozzle_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bulk_sales
    ADD CONSTRAINT bulk_sales_nozzle_id_fkey FOREIGN KEY (nozzle_id) REFERENCES public.nozzles(id);


--
-- Name: bulk_sales bulk_sales_shift_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bulk_sales
    ADD CONSTRAINT bulk_sales_shift_id_fkey FOREIGN KEY (shift_id) REFERENCES public.shifts(id);
...
ALTER TABLE ONLY public.credit_payments
    ADD CONSTRAINT credit_payments_recorded_by_fkey FOREIGN KEY (recorded_by) REFERENCES public.users(id);


--
-- Name: credit_payments credit_payments_vendor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.credit_payments
    ADD CONSTRAINT credit_payments_vendor_id_fkey FOREIGN KEY (vendor_id) REFERENCES public.vendors(id);
...
--
-- Name: expense_accounts expense_accounts_vendor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.expense_accounts
    ADD CONSTRAINT expense_accounts_vendor_id_fkey FOREIGN KEY (vendor_id) REFERENCES public.vendors(id) ON DELETE CASCADE;
...
--
-- Name: loyalty_transactions loyalty_transactions_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loyalty_transactions
    ADD CONSTRAINT loyalty_transactions_item_id_fkey FOREIGN KEY (item_id) REFERENCES public.items(id);
...
--
-- Name: sales sales_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sales
    ADD CONSTRAINT sales_item_id_fkey FOREIGN KEY (item_id) REFERENCES public.items(id);
...
--
-- Name: shift_banking shift_banking_banking_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.shift_banking
    ADD CONSTRAINT shift_banking_banking_account_id_fkey FOREIGN KEY (banking_account_id) REFERENCES public.banking_accounts(id) ON DELETE CASCADE;


--
-- Name: shift_banking shift_banking_shift_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.shift_banking
    ADD CONSTRAINT shift_banking_shift_id_fkey FOREIGN KEY (shift_id) REFERENCES public.shifts(id) ON DELETE CASCADE;


--
-- Name: shift_expenses shift_expenses_branch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.shift_expenses
    ADD CONSTRAINT shift_expenses_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id) ON DELETE CASCADE;


--
-- Name: shift_expenses shift_expenses_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.shift_expenses
    ADD CONSTRAINT shift_expenses_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id);


--
-- Name: shift_expenses shift_expenses_expense_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.shift_expenses
    ADD CONSTRAINT shift_expenses_expense_account_id_fkey FOREIGN KEY (expense_account_id) REFERENCES public.expense_accounts(id) ON DELETE RESTRICT;


--
-- Name: shift_expenses shift_expenses_shift_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.shift_expenses
    ADD CONSTRAINT shift_expenses_shift_id_fkey FOREIGN KEY (shift_id) REFERENCES public.shifts(id) ON DELETE CASCADE;
...
--
-- Name: shift_readings shift_readings_incoming_attendant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.shift_readings
    ADD CONSTRAINT shift_readings_incoming_attendant_id_fkey FOREIGN KEY (incoming_attendant_id) REFERENCES public.staff(id);
...
--
-- Name: staff staff_vendor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.staff
    ADD CONSTRAINT staff_vendor_id_fkey FOREIGN KEY (vendor_id) REFERENCES public.vendors(id);
...
\unrestrict uYXWa6W7VHLBJTX16ShgN5YN5CLduWzDMSvyZpe3xMBTtQtOW2pTkd7YrO2ziHl
